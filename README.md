...
```bash
git clone https://github.com/pop-marko/adidas-price-analysis-usa-vs-japan
cd adidas-price-analysis-usa-vs-japan
```
...
### 4. Open
```bash
notebook/adidas-price-analysis-usa-vs-japan.ipynb
```
Run all cells.
